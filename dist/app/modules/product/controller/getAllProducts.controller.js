...
const getAllProducts_services_1 = require("../services/getAllProducts.services");
...
exports.getAllProducts = (0, utils_1.catchAsync)(async (req, res, next) => {
    ...
    const result = await getAllProducts_services_1.ProductService.getProducts(req.query, userId);
    res.status(200).json({
        status: "success",
